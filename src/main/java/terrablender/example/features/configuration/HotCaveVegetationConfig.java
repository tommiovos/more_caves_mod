package terrablender.example.features.configuration;
...
public record HotCaveVegetationConfig(
        BlockState validBaseState,
        BlockState stemState,
        BlockState hatState,
        boolean planted
) implements FeatureConfiguration {
    public static final Codec<HotCaveVegetationConfig> CODEC = RecordCodecBuilder.create((builder) -> builder.group(
            ...
            ).apply(builder, HotCaveVegetationConfig::new)
    );
}